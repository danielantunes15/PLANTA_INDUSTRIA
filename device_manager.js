...
// Lista de setores para o Dropdown
...
async function loadDeviceList() {
    ...
    try {
        ...
        // Ordena por Setor e depois por Nome
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!document.getElementById('device-panel')) {
        // CORREÇÃO AQUI: Removido o style inline "right" que travava o menu
        const panelHTML = `
